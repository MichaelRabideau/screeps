        ...
        if(!creep.memory.delivering) {
            ...
            else
            {
              ...
              else
              {
                ...
                var containers = utils.findStructures(creep, [STRUCTURE_CONTAINER, STRUCTURE_LINK], 
                  function(structo){return utils.getEffectiveEnergy(structo) >= creep.carryCapacity;});
